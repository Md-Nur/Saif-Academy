...
<head>
    ...
    <title>HSC First Year New 1</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .header {
            ...
            color: white;
            background-position: center;
            background-image: radial-gradient( rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0)), url('bth.jpg');
            padding: 50px;
            text-align: right;
        }
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
        <a class="navbar-brand" href="#">
            <img src="logo.png" width="30" height="30" alt="HSC First Year New 1" loading="lazy">
        </a>
               ...
               <li class="nav-item active dropdown">
                    ...
                    Batch</a>
                     <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" target="_blank" href="ssc_1.php">HSC First Year New 1</a>
    ...
    <div class="notice">
        ...
        $sw = "SELECT * FROM `news` WHERE `Batch` = 'HSC First Year New 1'";
...
//database
        ...
        $sw5 = "SELECT * FROM `news` WHERE `Batch` = 'HSC First Year New 1'";
