...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <a class="navbar-brand" href="#">
            <img src="logo.png" width="30" height="30" alt="SSC 1" loading="lazy">
        </a>
    ...
    <div class="notice">
        ...
        $sw = "SELECT * FROM `news` WHERE `Batch` = 'SSC 1'";
...
//database
        ...
        $sw5 = "SELECT * FROM `news` WHERE `Batch` = 'SSC 1'";
