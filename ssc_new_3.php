...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <a class="navbar-brand" href="#">
            <img src="logo.png" width="30" height="30" alt="SSC New 3" loading="lazy">
        </a>
               ...
               <li class="nav-item active dropdown">
                    ...
                    Batch</a>
                     <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" target="_blank" href="ssc_1.php">SSC New 3</a>
    ...
    <div class="notice">
        ...
        $sw = "SELECT * FROM `news` WHERE `Batch` = 'SSC New 3'";
...
//database
        ...
        $sw5 = "SELECT * FROM `news` WHERE `Batch` = 'SSC New 3'";
