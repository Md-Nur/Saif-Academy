...
<head>
    ...
    <title>HSC Second Year New 1</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <a class="navbar-brand" href="#">
            <img src="logo.png" width="30" height="30" alt="HSC Second Year New 1" loading="lazy">
        </a>
    ...
    <div class="notice">
        ...
        $sw = "SELECT * FROM `news` WHERE `Batch` = 'HSC Second Year New 1'";
...
//database
        ...
        $sw5 = "SELECT * FROM `news` WHERE `Batch` = 'HSC Second Year New 1'";
...
<?php
      //database
        ...
        $show = "SELECT * FROM `z_hsc_second_year_new_1`";
