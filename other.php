...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <a class="navbar-brand" href="#">
            <img src="logo.png" width="30" height="30" alt="Other" loading="lazy">
        </a>
    ...
    <div class="notice">
        ...
        $sw = "SELECT * FROM `news` WHERE `Batch` = 'Other'";
...
//database
        ...
        $sw5 = "SELECT * FROM `news` WHERE `Batch` = 'Other'";
