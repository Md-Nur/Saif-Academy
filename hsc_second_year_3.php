...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <a class="navbar-brand" href="#">
            <img src="logo.png" width="30" height="30" alt="HSC Second Year 3" loading="lazy">
        </a>
               ...
               <li class="nav-item active dropdown">
                    ...
                    Batch</a>
                     <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" target="_blank" href="ssc_1.php">HSC Second Year 3</a>
    ...
    <div class="notice">
        ...
        $sw = "SELECT * FROM `news` WHERE `Batch` = 'HSC Second Year 3'";
...
//database
        ...
        $sw5 = "SELECT * FROM `news` WHERE `Batch` = 'HSC Second Year 3'";
...
<?php
      //database
        ...
        $show = "SELECT * FROM `z_hsc_second_year_3`";
